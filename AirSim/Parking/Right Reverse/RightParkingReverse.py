...
while True:
    ...
    camera_pose_r = airsim.Pose(airsim.Vector3r(0.4, 2, 0.5), airsim.to_quaternion(0, 0, 1.3))  # PRY in radians
    ...
    if (rawImage is None):
        ...
        # right
        right=cam.get_right_camera1(client)
